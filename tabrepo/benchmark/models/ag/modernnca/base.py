...
from tabrepo.benchmark.models.ag.modernnca.utils import (
    Timer,
    Averager,
    set_seeds,
    get_device
...
class Method(object, metaclass=abc.ABCMeta):
    ...
    def data_format(self, is_train=True, N=None, C=None, y=None):
        ...
        if is_train:
            ...
            self.N, self.num_encoder = num_enc_process(self.N, num_policy=self.args.num_policy,
                                                       n_bins=self.args.config['training']['n_bins'],
                                                       y_train=self.y['train'], is_regression=self.is_regression)
            ...
            N_test, _ = num_enc_process(N_test, num_policy=self.args.num_policy,
                                        n_bins=self.args.config['training']['n_bins'], y_train=None,
