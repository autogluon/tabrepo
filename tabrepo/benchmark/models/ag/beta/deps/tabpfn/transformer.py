...
import torch
from tabrepo.benchmark.models.ag.beta.deps.tabpfn import layer
...
class TransformerModel(nn.Module):
    def __init__(
        ...
        encoder_layer_creator = lambda: layer.TransformerEncoderLayer(
            ninp,
            nhead,
            nhid,
            dropout,
    ...
    def generate_global_att_trainset_matrix(
        ...
        seq_len + num_global_att_tokens - num_query_tokens
    ...
    def forward(self, src, src_mask=None, single_eval_pos=None):
        ...
        # print(train_x.dtype)
        src = torch.cat(
            [global_src, style_src, train_x, x_src[single_eval_pos:]], 0
        ).to(train_x.dtype)
    ...
    def init_from_small_model(self, small_model):
        ...
        assert isinstance(self.encoder, (nn.Linear, nn.Sequential))
