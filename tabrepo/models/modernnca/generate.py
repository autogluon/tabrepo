...
gen_modernnca = CustomAGConfigGenerator(model_cls=ModernNCAModel, search_space_func=generate_configs_modernnca,
                                          manual_configs=[{}])
...
if __name__ == '__main__':
    ...
    experiments_default = generate_bag_experiments(model_cls=ModernNCAModel, configs=config_defaults, time_limit=3600,
                                                   name_id_prefix="c")
