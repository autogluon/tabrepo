...
def load_context_2023_02_27_bag_208(
        folds=None,
    ...
    path_bagged_root = Paths.bagged_208_results_root
    path_bagged_root_s3 = 's3://automl-benchmark-ag/aggregated/ec2/2023_02_27_zs/'
    ...
    if load_from_local:
        ...
        raw_path = str(path_bagged_root / "openml_ag_2023_02_27_zs_models.csv")
    else:
        results_path = f"{path_bagged_root_s3}results_ranked_valid.csv"
        results_by_dataset_path = f"{path_bagged_root_s3}results_ranked_by_dataset_valid.csv"
        raw_path = f"{path_bagged_root_s3}openml_ag_2023_02_27_zs_models.csv"
    ...
    path_prefix_automl = Paths.results_root / 'automl_208'
