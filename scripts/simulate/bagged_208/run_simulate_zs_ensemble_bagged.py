...
from autogluon_zeroshot.contexts.context_2023_02_27_bag_208 import load_context_2023_02_27_bag_208, get_configs_default
...
if __name__ == '__main__':
    ...
    for problem_type in [None]:
        ...
        results_cv: PortfolioCV = run_zs_simulation(
            ...
            n_splits=5,
            configs=configs,
            # config_generator_kwargs={'num_zeroshot': 6},
            backend=backend,
        )
